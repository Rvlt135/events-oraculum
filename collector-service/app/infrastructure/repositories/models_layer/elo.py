...
class EloRepository(BaseRepository[EloModel]):
    ...
    async def bulk_upsert_elo_model(self, elo_outputs: list[EloModelDTO]) -> int:
        ...
        stmt = stmt.on_conflict_do_update(
            constraint="uq_elo_model_event_id",
            set_={
                "p_home": stmt.excluded.p_home,
                "p_draw": stmt.excluded.p_draw,
                "p_away": stmt.excluded.p_away,
                "expected_result_home": stmt.excluded.expected_result_home,
                "expected_result_away": stmt.excluded.expected_result_away,
