...
class PoissonModelRepository(BaseRepository[EloModel]):
    def __init__(self, session: AsyncSession):
        super().__init__(EloModel, session)

    async def bulk_upsert_poisson_model(self, elo_outputs: list[PoissonInputFeaturesDTO], competition_id: UUID, season: int) -> int:
        pass